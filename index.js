...
console.log(createMenuItem('Veggie Wrap', 5.99, 'Lunch'))
console.log(createMenuItem('Club Sandwhich', 11.99, 'Lunch'))
console.log(createMenuItem('Triple Chocolate', 8.99, 'Desert'))
...
reviews.push({ name: "TimBim", rating: 10, feedback: "Slaps!" });
